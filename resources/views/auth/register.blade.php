...
<div class="max-w-md w-full space-y-8 p-10 rounded-xl z-10 bg-opacity-60" style="backdrop-filter: blur(40px);">
    <div class="text-center">
        ...
        <p class="mt-2 text-sm text-white">Register an account</p>
    </div>
    ...
    <form class="mt-8 space-y-6" method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div class="relative">
            <label class="text-sm font-bold text-white tracking-wide" for="name">Name</label>
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <label class="text-sm font-bold text-white tracking-wide" for="password_confirmation">Confirm Password</label>
        ...
        <p class="flex flex-col items-center justify-center mt-10 text-center text-md text-white">
            ...
            <a href="{{ route('login') }}" class="text-indigo-500 hover:text-indigo-500no-underline hover:underline cursor-pointer transition ease-in duration-300">Sign in</a>
        </p>
    </form>
</div>
</div>
