...
style="background-image: url(https://images.unsplash.com/photo-1524578271613-d550eacf6090?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80);">
<div class="absolute bg-black opacity-50 inset-0 z-0"></div>
<div class="max-w-md w-full space-y-8 p-10 rounded-xl z-10 bg-opacity-60" style="backdrop-filter: blur(40px);">
    <div class="text-center">
        <h2 class="mt-6 text-3xl font-bold text-white">
            Educational Portal
        </h2>
        <p class="mt-2 text-sm text-white">Please sign in to your account</p>
    </div>
    ...
    <form class="mt-8 space-y-6" method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-8 content-center">
            <label class="text-sm font-bold text-white tracking-wide" for="password">Password</label>
        ...
        <div class="flex items-center justify-between">
                <div class="flex items-center" for="remember_me">
                    <input id="remember_me" name="remember" type="checkbox" class="h-4 w-4 bg-white focus:ring-indigo-400 border-gray-300 rounded">
            ...
            <div class="text-sm">
                ...
                <a href="{{ route('password.request') }}" class="font-medium text-indigo-500 hover:text-indigo-500">
        ...
        <p class="flex flex-col items-center justify-center mt-10 text-center text-md text-white">
            ...
            <a href="{{ route('register') }}" class="text-indigo-500 hover:text-indigo-500no-underline hover:underline cursor-pointer transition ease-in duration-300">Sign up</a>
        </p>
    </form>
</div>
</div>
