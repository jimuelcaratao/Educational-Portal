<x-user-layout>
        ...
        <div class="carousel relative shadow-2xl bg-white">
            ...
            <!--Slide 1-->
                ...
                <div class="carousel-item absolute opacity-0" style="height:100vh;">
                    <div class="bg-cover bg-center block h-full w-full px-32 py-72 text-white object-fill" style="background-image: url(https://images.unsplash.com/photo-1544427920-c49ccfb85579?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1422&q=80)">
                        <div class="md:w-1/2">
        ...
        <div class="container px-7 sm:px-1 lg:px-10 xl:px-12 mx-auto">
            <div class="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                ...
                <div class="hero-text col-span-6">
                    <h1 class=" font-bold text-4xl md:text-5xl max-w-xl text-gray-900" style="line-height: 1.375;" data-aos="zoom-in">Help students stay updated at Educational Portal</h1>
                    <hr class=" w-12 h-1 bg-[#717052] rounded-full mt-8" data-aos="zoom-in">
                    <p class="text-gray-800 text-base leading-relaxed mt-8 font-semibold" data-aos="zoom-in">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec posuere, massa in ornare tempus, lacus lacus aliquam diam, nec eleifend urna orci et justo.</p>
            ...
            <div class="focus:outline-none mt-12 lg:mt-16">
                <div  class="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                    <div class="focus:outline-none" aria-label="card 1">
                        <img role="img" aria-label="code editor" class="focus:outline-none w-full" src="https://cdn.tuk.dev/assets/components/111220/Blg-6/blog(1).png" alt="code editor" />
                    ...
                    <div>
                        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                            <div class="focus:outline-none " aria-label="card 2" >
                                <img role="img" aria-label="gaming" class="focus:outline-none w-full" src="https://cdn.tuk.dev/assets/components/111220/Blg-6/blog(2).png" alt="games" />
                                ...
                                <div class="bg-white px-3 lg:px-6 py-4 rounded-bl-3xl rounded-br-3xl">
                                    <h1 class="focus:outline-none text-lg text-gray-900 font-semibold tracking-wider">Transactions</h1>
                                    <p class="focus:outline-none text-gray-700 text-sm lg:text-base lg:leading-8 pr-4 tracking-wide mt-2">Find the latest events updates or create events, concerts, conferences, workshops...</p>
                                </div>
                            </div>
                            <div  class="focus:outline-none" aria-label="card 3">
                                <img role="img" aria-label="gaming" class="focus:outline-none w-full" src="https://cdn.tuk.dev/assets/components/111220/Blg-6/blog(3).png" alt="notes" />
                                <div class="py-2 px-4 w-full flex justify-between bg-indigo-700">
                                    <p class="focus:outline-none text-sm text-white font-semibold tracking-wide">Bruce Wayne</p>
                                    <p class="focus:outline-none text-sm text-white font-semibold tracking-wide">13TH Oct, 2020</p>
                                </div>
                        ...
                        <div class="mt-10 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                            <div class="focus:outline-none " aria-label="card 4">
                                <img role="img" aria-label="laptop" class="focus:outline-none w-full" src="https://cdn.tuk.dev/assets/components/111220/Blg-6/blog(4).png" alt="laptop" />
                                <div class="py-2 px-4 w-full flex justify-between bg-indigo-700">
                                    <p class="focus:outline-none text-sm text-white font-semibold tracking-wide">Bruce Wayne</p>
                                    <p class="focus:outline-none text-sm text-white font-semibold tracking-wide">13TH Oct, 2020</p>
                                </div>
                            ...
                            <div class="focus:outline-none" aria-label="card 5">
                                <img role="img" aria-label="worker" class="focus:outline-none w-full" src="https://cdn.tuk.dev/assets/components/111220/Blg-6/blog(5).png" alt="worker" />
                                <div class="py-2 px-4 w-full flex justify-between bg-indigo-700">
                                    <p class="focus:outline-none text-sm text-white font-semibold tracking-wide">Bruce Wayne</p>
                                    <p class="focus:outline-none text-sm text-white font-semibold tracking-wide">13TH Oct, 2020</p>
                                </div>
    ...
    <div class="relative" style="padding-top: 56.25%">
        <iframe class="absolute inset-0 w-full h-full px-4 xl:px-36 md:py-14" src="https://www.youtube-nocookie.com/embed/FMrtSHAAPhM" frameborder="0" …></iframe>
      </div>
    </div>
    ...
    <div id="history" class="container mx-auto px-4 py-28">
        ...
        <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
            ...
            <img alt="..." src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1051&amp;q=80" class="w-full align-middle rounded-lg">
            </div>
        </div>
        </div>
    </div>
