<x-guest-layout>
     ...
     <!-- 2nd Academic Achievers -->
     <div id="profs" class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-10">
        <div class="text-center pb-12">
            <h1 class="font-bold text-3xl md:text-4xl font-heading text-[#FE6034]">
                Second Year Academic Achievers
            </h1>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="w-full bg-white rounded-lg shadow-lg p-12 flex flex-col justify-center items-center">
    ...
    <!-- 3rd Academic Achievers -->
    <div id="profs" class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-10">
        <div class="text-center pb-12">
            <h1 class="font-bold text-3xl md:text-4xl font-heading text-[#FE6034]">
                Third Year Academic Achievers
            </h1>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="w-full bg-white rounded-lg shadow-lg p-12 flex flex-col justify-center items-center">
    ...
    <!-- 4th Academic Achievers -->
    <div id="profs" class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-10">
        <div class="text-center pb-12">
            <h1 class="font-bold text-3xl md:text-4xl font-heading text-[#FE6034]">
                Fourth Year Academic Achievers
            </h1>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="w-full bg-white rounded-lg shadow-lg p-12 flex flex-col justify-center items-center">
