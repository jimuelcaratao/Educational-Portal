            ...
            <div class="overflow-hidden">
                ...
                <div class="flex flex-wrap  px-6 mx-0 md:mx-4 mb-4 md:mb-8 md:mb-6 md:mt-4">
                    <div class="w-full px-6 py-8 bg-gradient-to-r from-purple-200 to-purple-400 rounded shadow-sm">
                        <h2 class="font-bold text-gray-700 text-lg md:text-2xl">{{ $dayTerm ?? null }}, <span
                            ...
                            <div
                                ...
                                <div class="flex flex-row items-center">
                                    ...
                                    <div class="flex-1 text-right md:text-center">
                                        <h5 class="font-bold uppercase text text-gray-600 text-sm">Total Thesis</h5>
                                        <h3 class="font-bold text-2xl text-black">{{ $total_thesis ?? null }}<span
                        ...
                        <a href="" class="text-decoration-none">
                            <div
                                ...
                                <div class="flex flex-row items-center">
                                    ...
                                    <div class="flex-1 text-right md:text-center">
                                        <h5 class="font-bold uppercase text-gray-600 text-sm">Active Thesis</h5>
                                        <h3 class="font-bold text-2xl text-black">{{ $active_thesis ?? null }}<span
                            ...
                            <div
                                ...
                                <div class="flex flex-row items-center">
                                    ...
                                    <div class="flex-1 text-right md:text-center">
                                        ...
                                        <h3 class="font-bold text-2xl text-black">{{ $new_users ?? null }}<span
                            ...
                            <div
                                ...
                                <div class="flex flex-row items-center">
                                    ...
                                    <div class="flex-1 text-right md:text-center">
                                        ...
                                        <h3 class="font-bold text-2xl text-black">{{ $users ?? null }} <span
                ...
                <div class="flex flex-row flex-wrap flex-grow">
                    ...
                    <div class="w-full  xl:w-1/3 p-4 lg:pl-10">
                        <div class="bg-white h-96 rounded p-5 shadow-md hover:shadow-xl transition delay-75">
                            <h3 class="font-bold text-2xl">Most Popular Thesis</h3>
